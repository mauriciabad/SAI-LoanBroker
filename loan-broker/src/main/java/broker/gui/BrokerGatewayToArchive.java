...
public class BrokerGatewayToArchive extends MessagerGateway<Object, ArchiveRequest> {
    ...
    private final MessagerGatewayREST<Object, ArchiveRequest> gateway = new MessagerGatewayREST<Object, ArchiveRequest>("http://localhost:8080/archive/rest/accepted", Object.class, ArchiveRequest.class);

    public BrokerGatewayToArchive() {}
    public void send(ArchiveRequest message, MessageReceived<Object> onReply){ gateway.send(message); }
